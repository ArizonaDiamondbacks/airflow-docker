...
JSON_PATH = "/opt/airflow/test_json_files".strip()
BUCKET_NAME = "azd-hawkeyeplayertracking-databricks-east".strip()
MANIFEST_FILE_KEY = "json_test/manifest.avro".strip()
S3_PATH_URL = "s3://azd-hawkeyeplayertracking-databricks-east/json_test/output/rust".strip()
...
@dag(
    dag_id='hawkeye_batched_test',
    schedule_interval=None,
    start_date=datetime(2024, 1, 1),
    catchup=False,
)
def hawkeye_batched_test():
...
hawkeye_batched_test_dag = hawkeye_batched_test()
